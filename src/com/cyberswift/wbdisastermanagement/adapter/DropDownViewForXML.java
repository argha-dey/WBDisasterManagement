 ...
 * @author st0le
 */
public class DropDownViewForXML extends TextView implements OnClickListener, OnItemClickListener, OnDismissListener,
	...
	private void init() {
		...
		/*
		 * if(Util.checkScreenRES(mContext)) { textSize = 13; popupHeight = 150;
		 * } else { textSize = 17; popupHeight = 223; }
		 */
	...
	private void setAdapter(PopupListItemAdapter adapter) {
		if (adapter != null) {
			...
			lv.setBackgroundResource(R.drawable.grey_border_box); // <--
																	// uncomment
																	// this
			lv.setAdapter(adapter);
			ColorDrawable green = new ColorDrawable(Color.parseColor("#888888"));
			lv.setDivider(green);
	...
	private class PopupListItemAdapter extends ArrayAdapter<PopupListItem> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (convertView == null) {
				...
				viewHolder.tvText.setPadding(10, 10, 10, 10);
