...
public class SpeedTestService extends Service {
	...
	private int UPDATE_THRESHOLD = 300;
	...
	public void onCreate() {
		...
		//		Toast.makeText(SpeedTestService.this, "onCreate called", Toast.LENGTH_SHORT).show();
	}
	...
	private final Runnable mWorker = new Runnable() {
		...
		public void run() {
			...
			try {
				...
				String downloadFileUrl = ServiceConnector.getRedirectionURL() + "CheckService";
				...
				sendingBroadcast(false, e.getMessage());
			} catch (IOException e) {
				Log.e(TAG, e.getMessage());
				sendingBroadcast(false, e.getMessage());
			} finally {
